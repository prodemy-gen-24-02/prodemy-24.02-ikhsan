...
const Thumbnail = () => {
    ...
    const addToCart = () => {
        setDataCheckout(existProduct => {
            return [...existProduct, { ...product, qty}]
        });
      };
                                    ...
                                    <div className="mt-5 flex gap-3 w-[30rem]">
                                        {
                                            product
                                                ...
                                                .map((size) => (
                                                    <a href="" key={size}>
                                                        <div
                                                            className="flex border border-black rounded-lg w-14 h-8 justify-center items-center hover:bg-gray-100">
                                                            <p>{size}</p>
                                                        </div>
                                                    </a>
                                                ))

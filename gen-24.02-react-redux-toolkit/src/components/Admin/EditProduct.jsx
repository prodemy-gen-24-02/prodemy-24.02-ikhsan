...
const EditProduct = () => {
    ...
    const onSubmitForm = (data) =>{
        ...
        // axios.post("https://api.cloudinary.com/sansan/image/upload/api/", formData).then(resp => {
        //     const payload = {
        //         brand:data.brand,
        //         name:data.name,
        //         price:data.price,
        ...
        //     };
            ...
            axios.put(`http://localhost:3000/products/${id}`, payload).then(() => {
                reset();
                mutate();
            }) .catch (err => {
                console.log(err)
        ...
        <div className="fixed flex justify-center items-center inset-0 bg-black bg-opacity-25 backdrop-blur-sm z-50">
            {isLoading||!product ? 
                ...
                <form 
                    ...
                    <div className="flex">
                        <h2 className="font-bold text-xl pb-5">Edit Product</h2>

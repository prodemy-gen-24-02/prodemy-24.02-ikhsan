...
const Thumbnail = () => {
    ...
    const [selectedSize, setSelectedSize] = useState(product?.size[0]||40);
    ...
    const addToCart = () => {
        const payload = {...product, qty, selectedSize}
                        ...
                        <div className="grid grid-cols-2 gap-5 mt-40 mx-auto">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <div className="w-[25rem] rounded-2xl p-1 shadow-lg">
                                    <img 
                                        // src={thumbnailMain}
                                        src= {thumbnailMain||import.meta.env.BASE_URL + product?.image[0]}
                                            ...
                                            product
                                                ...
                                                .map((size) => (
                                                    <li key={size}>
                                                        ...
                                                        <label htmlFor={size} className="has-[:checked]:bg-black has-[:checked]:text-white has-[:checked]:ring-indigo-200 flex border border-black rounded-lg w-14 h-8 justify-center items-center hover:bg-neutral-100 active:bg-white cursor-pointer">{size}
                                                            <input type="radio" id={size} name="hosting" value={size} className="hidden" required onChange={selectSize}/>
                                                        </label>
                                                    </li>
                                             ))
                                            }

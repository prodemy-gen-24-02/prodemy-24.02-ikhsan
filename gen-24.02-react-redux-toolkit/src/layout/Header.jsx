            ...
            <div className="flex items-center justify-center my-5">
                    ...
                    <form action="">
                        ...
                        <button
                            ...
                            <svg
                                ...
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                                className="inline-block h-6 w-6 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                ...
                <div className="flex gap-5 items-center">
                    ...
                    <Link to={"/checkout"} className='flex'>
                        ...
                        <div className='flex justify-center items-center rounded-full absolute right-[85px] top-[40px] p-1 w-5 h-5 text-sm bg-black text-white text-[10px]'>0</div>
                             : <p className='flex justify-center items-center rounded-full absolute right-[85px] top-[40px] p-1 w-5 h-5 text-sm bg-black text-white text-[10px]'>{dataCheckout.length}</p>
                        }
                    </Link>
                </div>
            </div>

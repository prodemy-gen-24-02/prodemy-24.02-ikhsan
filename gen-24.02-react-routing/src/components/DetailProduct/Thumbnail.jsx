...
const Thumbnail = ({product}) => {
    ...
    const { id } = useParams();
    const details = product.find(obj => obj.id === parseInt(id));
    ...
    return (
        <div className="grid grid-cols-2 gap-5 mt-40 mx-auto">
            <div className="flex flex-col items-center pr-[20%]">
                ...
                <div className="flex w-[30rem] justify-center gap-3 mt-5" key={details.id}>
